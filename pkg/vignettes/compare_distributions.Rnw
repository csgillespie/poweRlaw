...
function\footnote{The \cc{compare\_distributions} function also returns a one
  sided $p$-value. Essentially, the one side $p$-value is testing whether the
