...
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/v2_figure1a-crop}
...
<<echo=FALSE, cache=TRUE>>=
pdf("knitr_graphics/v2_figure1a.pdf", width=4, height=4)
...
sink = dev.off()
system("pdfcrop knitr_graphics/v2_figure1a.pdf")
@
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{knitr_graphics/v2_figure1b-crop}
...
\centering
\includegraphics[width=\textwidth]{knitr_graphics/v2_figure1c-crop}
...
<<echo=FALSE>>=
pdf("knitr_graphics/v2_figure1b.pdf", width=12, height=9)
plot(bs)
sink=dev.off()
system("pdfcrop knitr_graphics/v2_figure1b.pdf")

pdf("knitr_graphics/v2_figure1c.pdf", width=4, height=8)
...
grid()
sink = dev.off()
system("pdfcrop knitr_graphics/v2_figure1c.pdf")
data(bootstrap_p_moby)
bs_p = bootstrap_p_moby
@
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{knitr_graphics/v2_figure1d-crop}
...
<<echo=FALSE, cache=TRUE>>=
pdf("knitr_graphics/v2_figure1d.pdf", width=12, height=9)
setnicepar(mfrow=c(2, 1))
plot(bs_p)
sink = dev.off()
system("pdfcrop knitr_graphics/v2_figure1d.pdf")
@
...
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/v2_figure1e-crop}
...
<<echo=FALSE, cache=TRUE>>=
pdf("knitr_graphics/v2_figure1e.pdf", width=4, height=4)
setnicepar(mfrow=c(1, 1))
...
sink = dev.off()
system("pdfcrop knitr_graphics/v2_figure1e.pdf")
@
...
\begin{marginfigure}[5\baselineskip]
\centering
\includegraphics[width=\textwidth]{knitr_graphics/v2_figure2a-crop}
...
<<echo=FALSE, cache=TRUE>>=
pdf("knitr_graphics/v2_figure2a.pdf", width=4, height=4)
setnicepar(mfrow=c(1,1))
...
sink = dev.off()
system("pdfcrop knitr_graphics/v2_figure2a.pdf")
@
...
\begin{figure}[b]
\centering
\includegraphics[width=0.9\textwidth]{knitr_graphics/v2_figure3a-crop}
...
@
\begin{marginfigure}
\includegraphics[width=\textwidth]{knitr_graphics/v2_figure3b-crop}
...
<<echo=FALSE, cache=TRUE>>=
pdf("knitr_graphics/v2_figure3a.pdf", width=6, height=4)
setnicepar()
...
points(us_american$Date, us_american$Cas, 
       pch=24, bg=2, cex=0.5)
sink = dev.off()
system("pdfcrop knitr_graphics/v2_figure3a.pdf")

pdf("knitr_graphics/v2_figure3b.pdf", width=4, height=4)
setnicepar()
...
sink = dev.off()
system("pdfcrop knitr_graphics/v2_figure3b.pdf")
