...
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/figure1-crop}
...
<<echo=FALSE>>=
mypalette(1)
pdf("knitr_graphics/figure1.pdf", width=4, height=4)
setnicepar()
...
sink=dev.off()
system("pdfcrop knitr_graphics/figure1.pdf")
data(bootstrap_moby)
bs = bootstrap_moby
...
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/figure2-crop}
...
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/figure3-crop}
...
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/figure4-crop}
\caption{Histograms of the bootstrap results.}\label{F4}
\end{marginfigure}
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/figure5-crop}
...
<<echo=FALSE>>=
pdf("knitr_graphics/figure2.pdf", width=4, height=7)
...
grid()
sink=dev.off()
system("pdfcrop knitr_graphics/figure2.pdf")

pdf("knitr_graphics/figure3.pdf", width=4, height=4)
...
sink = dev.off()
system("pdfcrop knitr_graphics/figure3.pdf")
@



<<echo=FALSE>>=
pdf("knitr_graphics/figure4.pdf", width=4, height=7)
setnicepar(mfrow=c(2, 1))
...
grid()
sink=dev.off()
system("pdfcrop knitr_graphics/figure4.pdf")

pdf("knitr_graphics/figure5.pdf", width=4, height=4)
setnicepar(mfrow=c(1,1))
plot(jitter(bs_p$bootstraps[,2], factor=1.2), bs_p$bootstraps[,3], 
     ...
     panel.first= grid())
sink = dev.off()
system("pdfcrop knitr_graphics/figure5.pdf")
@
...
\centering
\includegraphics[width=\textwidth]{knitr_graphics/figure6-crop}
...
m_bl$setXmin(est)
pdf("knitr_graphics/figure6.pdf", width=4, height=4)
setnicepar(mfrow=c(1,1))
plot(m_bl, panel.first=grid())
lines(m_bl, col=2)
sink = dev.off()
system("pdfcrop knitr_graphics/figure6.pdf")
@
...
\begin{marginfigure}
\centering
\includegraphics[width=\textwidth]{knitr_graphics/figure7-crop}
...
<<echo=FALSE>>=
pdf("knitr_graphics/figure7.pdf", width=4, height=4)
setnicepar(mfrow=c(1,1))
plot(m_r, ylab="CDF", 
     pch=21, bg=1, cex=0.5, 
...
sink = dev.off()
system("pdfcrop knitr_graphics/figure7.pdf")
@
