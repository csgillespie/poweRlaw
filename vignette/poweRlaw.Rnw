...
\end{marginfigure}
\noindent The object return by \texttt{bootstrap}  is list, with three elements: 
\begin{itemize}
...
@
\noindent This gives figures \ref{F2} and \ref{F3}.
...
<<eval=FALSE>>=
##This takes a while
##This use the mle to estimate the parameters
...
\begin{table}[h]
  ...
  \begin{tabular}{@{} lp{7.5cm} @{}}
    ...
    \texttt{bootstrap} & Bootstrap procedure\\
